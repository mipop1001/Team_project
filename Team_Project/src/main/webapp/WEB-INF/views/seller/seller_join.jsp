...
<script type="text/javascript">
	...
	function seller_join_check() {
		...
		// "-"를 제거하고 공백도 제거
		var sanitized_phone_number = seller_phone_number.replace(/-/g, '')
				.replace(/\s/g, '');
		...
		<caption>회원가입</caption>
			<tr>
				...
				<td><hr><input type="text" id="seller_id" name="seller_id"
					placeholder="아이디를 입력하세요." style="width: 170px;"> <input type="button" id="btn"
					value="아이디 중복 확인"></td>
			</tr>

			<tr>
				<th>비밀번호</th>
				<td><hr><input type="text" id="seller_password"
					name="seller_password" placeholder="비밀번호를 입력하세요." style="width: 300px;"></td>
			</tr>

			<tr>
				<th>이름</th>
				<td><hr><input type="text" id="seller_name" name="seller_name"
					placeholder="이름을 입력하세요..." style="width: 300px;"></td>
			</tr>

			<tr>
				<th>전화번호</th>
				<td><hr><input type="text" id="seller_phone_number"
					name="seller_phone_number" placeholder="-빼고 입력하세요." style="width: 300px;"></td>
			</tr>

			<tr>
				<th>이메일</th>
				<td><hr><input type="text" id="seller_email" name="seller_email"
					placeholder="이메일을 입력하세요." style="width: 300px;"></td>
			</tr>

			<tr>
				<th>사업자번호</th>
				<td><hr><input type="text" id="seller_company_number"
					name="seller_company_number" placeholder="-를뺀 10자리 사업자번호를 입력하세요."
			...
			<tr>
				...
				<td><hr><input type="text" id="seller_company_address"
					name="seller_company_address" placeholder="사업장주소를 입력하세요." style="width: 300px;"></td>
			</tr>
