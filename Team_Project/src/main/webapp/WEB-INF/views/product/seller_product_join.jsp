...
<body>
	<script type="text/javascript">
		function check() {
			var sellerproductform = document
					.getElementById("seller_product_form");

			// 체크해야 하는 질문 목록
			var requiredQuestions = [ "seller_id", "product_name",
					"product_country", "product_maker", "product_price",
					"product_sell_amount", "product_sum_image",
					"product_detail_image1", "product_detail_image2",
						...
						<table align="center" width="600px">
							...
							<tr>
								...
								<td><hr> <input type="text" name="product_name"
									id="product_name" style="width: 300px;"></td>
							</tr>

							<tr>
								<th>원산지</th>
								<td><hr> <input type="text" name="product_country"
									id="product_country" style="width: 300px;"></td>
							</tr>

							<tr>
								<th>메이커</th>
								<td><hr> <input type="text" name="product_maker"
									id="product_maker" style="width: 300px;"></td>
							</tr>

							<tr>
								<th>가격</th>
								<td><hr> <input type="text" name="product_price"
									id="product_price" style="width: 300px;"></td>
							</tr>
							...
							<tr>
								<th>이미지 미리보기</th>
								<td><hr>
									<div id="image_container" width="50px" height="50px"></div>
									<hr></td>
							</tr>
							<tr>
								<th>썸네일이미지</th>
								<td><hr> <input type="file" class="file_btn" name="product_sum_image"
									id="product_sum_image" onchange="setThumbnail(event);"></td>
							</tr>
							<tr>
								<th>상세이미지1</th>
								<td><hr> <input type="file"
									name="product_detail_image1" class="file_btn" id="product_detail_image1"
									onchange="setThumbnail(event);"></td>
							</tr>
							<tr>
								<th>상세이미지2</th>
								<td><hr> <input type="file"
									name="product_detail_image2" class="file_btn" id="product_detail_image2"
									onchange="setThumbnail(event);"></td>
							</tr>
							<tr>
								<th>상세이미지3</th>
								<td><hr> <input type="file"
									name="product_detail_image3" class="file_btn" id="product_detail_image3"
									onchange="setThumbnail(event);"></td>
							</tr>
